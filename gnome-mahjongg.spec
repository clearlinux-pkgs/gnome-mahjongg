...
Source0  : https://download.gnome.org/sources/gnome-mahjongg/3.36/gnome-mahjongg-3.36.2.tar.xz
...
%prep
%setup -q -n gnome-mahjongg-3.36.2
cd %{_builddir}/gnome-mahjongg-3.36.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588036756
...
cp %{_builddir}/gnome-mahjongg-3.36.2/COPYING %{buildroot}/usr/share/package-licenses/gnome-mahjongg/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/gnome-mahjongg-3.36.2/help/C/license.page %{buildroot}/usr/share/package-licenses/gnome-mahjongg/99449fd3e6417f1f32dbe2a5b252880badb25704
