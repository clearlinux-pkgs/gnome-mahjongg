...
Version  : 47.0
Release  : 18
URL      : https://download.gnome.org/sources/gnome-mahjongg/47/gnome-mahjongg-47.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-mahjongg/47/gnome-mahjongg-47.0.tar.xz
...
%prep
%setup -q -n gnome-mahjongg-47.0
cd %{_builddir}/gnome-mahjongg-47.0
pushd ..
cp -a gnome-mahjongg-47.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726765771
