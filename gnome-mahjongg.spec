...
Version  : 3.40.1
Release  : 17
URL      : https://download.gnome.org/sources/gnome-mahjongg/3.40/gnome-mahjongg-3.40.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-mahjongg/3.40/gnome-mahjongg-3.40.1.tar.xz
...
%prep
%setup -q -n gnome-mahjongg-3.40.1
cd %{_builddir}/gnome-mahjongg-3.40.1
pushd ..
cp -a gnome-mahjongg-3.40.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713797945
