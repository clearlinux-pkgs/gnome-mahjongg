...
Version  : 3.33.90
Release  : 2
URL      : https://download.gnome.org/sources/gnome-mahjongg/3.33/gnome-mahjongg-3.33.90.tar.xz
Source0  : https://download.gnome.org/sources/gnome-mahjongg/3.33/gnome-mahjongg-3.33.90.tar.xz
...
%prep
%setup -q -n gnome-mahjongg-3.33.90
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568044920
